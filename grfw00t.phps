...
#	}
	...
	if (!count($aErrors))
	{
		...
		$message = e($sMsg);
		$headers = 'From: freenode Group Registration System <gms@freenode.net>' . "\r\n";
...
<form class="none" action="group_registration_form.php" method="post" style="width:100%; font-size:12px;">
    <div id="fngmstabs" class="TabbedPanels" style="width:100%;">
      ...
      onmouseout="UnTip()" />
		...
		onmouseover="Tip('\
      <b>Captcha</b><br />\
      To prevent automated (and malicious) group registrations, we require that you enter the numbers and letters you see from the image.\
      ')"
      onmouseout="UnTip()" />
	      </td>
              <td>&nbsp;</td>
